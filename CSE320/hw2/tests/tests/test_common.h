...
#define REF_PROGNAME "tests/browse_stubbed"
#define PROGNAME "bin/browse_stubbed"
...
int run_using_system(char *name, char *test_name, char *limits, char *pre_cmd, char *valgrind_cmd);
